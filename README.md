...
|                                    |          |                                           |
|   ===============================  |          |     ===================================   |
|   ||     Room API (Socket)     ||  |   bi     |     ||  App.JS - Websocket API       ||   |
|   ||   -------------------     ||  |direction |     ||  ---------------------        ||   |                       
|   ||   |  roomState      | <==========================> | roomState         |        ||   |
|   ||   -------------------     ||  |          |     ||  ---------------------        ||   |
|   ===============================  |          |     ||                               ||   |
|                                    |          |     ||                               ||   |
|   ===============================  |          |     ||                               ||   |
|   ||     Video API (REST)      ||  |          |     ||  VideoApi (REST)              ||   |
|   ||     Room  API (REST)      ||  |  uni     |     ||  RoomApi (REST)               ||   |    
|   ||   -------------------     ||  |direction |     ||  ---------------------        ||   |
...
- [ ] Add a sync API, but with debounce (once every 5 minutes)
